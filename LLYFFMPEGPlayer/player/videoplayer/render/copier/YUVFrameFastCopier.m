...
- (void) uploadTexture:(LLYVideoFrame*) videoFrame width:(int) frameWidth height:(int) frameHeight;
{
    CVImageBufferRef pixelBuffer = nil;
    if(videoFrame.frameType == LLYFrameType_Video){
        pixelBuffer = [self buildCVPixelBufferByVideoFrame:videoFrame width:frameWidth height:frameHeight];
    } else if(videoFrame.frameType == LLYFrameType_HardVideo) {
...
- (CVPixelBufferRef) buildCVPixelBufferByVideoFrame:(LLYVideoFrame*) videoFrame width:(int) frameWidth height:(int) frameHeight;
{
